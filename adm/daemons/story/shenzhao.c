...
nosave mixed *story = ({
	...
	"陈劲南道：“阁下武功高强，但阁下侠义热血更为可贵，今日和阁下携手一战，畅快无比。”",
	"$N笑道：“陈总舵主名满天下，今日一见，武功果然了得！”",
	"陈劲南微笑道：“看阁下是武林中人，这套败血伸爪是集我毕生精力所创，今日便赠予阁下，多行侠事。”",
	( : give_gift:),
});
...
int give_gift()
{
	...
	tell_object(ob, HIC "你从陈劲南那里学习到了败血伸爪。" NOR "\n");
	CHANNEL_D->do_channel(this_object(), "rumor", "听说" + ob->name(1) + "从陈劲南那里学习到了败血伸爪。");
