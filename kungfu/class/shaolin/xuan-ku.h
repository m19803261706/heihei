...
int waiting(object me)
{
	...
	{
		if (random(10) == 0)
		say("\n玄枯说道：" + RANK_D->query_respect(fighter) +
		    "去请了玄劫大师没有？ 照理他现在该到了罢？\n");
...
int do_recruit(object me, object fighter)
{
	...
	{
		command("bow");
		say("玄枯说道：" + RANK_D->query_respect(fighter) +
		    "此番过阵，当对本身修行大有助益，百尺竿头，更"
		    "进一步，老衲就此别过！\n");
		call_out("do_back", 5, me );
	} else
	{
		say("\n玄枯说道：恭喜你闯过了十八罗汉大阵！ 本寺有"
		    "此等杰出弟子，届时必当为武林放一异彩！\n");
