...
int waiting(object me)
{
	...
	{
		if( random(10) == 0 ) 
		say("\n玄劫说道：" + RANK_D->query_respect(fighter) + "去请了玄枯大师没有？ 照理他现在该到了罢？\n");
...
int preparing(object me, object fighter)
{
	...
	say("玄劫说道：不相干的人，如不欲现场观摩罗汉大阵，请即刻离开此处。\n");

	message("vision", HIY "\n玄劫大师大声宣布：西罗汉大阵合围！"NOR"\n",
		room);
...
int do_recruit(object me, object fighter)
{
	...
	{
		command("smile");
		say("玄劫说道：" + RANK_D->query_respect(fighter) + "武功卓绝，兼又手下留情，品德更是过人一筹，老衲不胜佩服之至！\n");
		call_out("do_back", 5, me );
	}
	else
	{
		say("\n玄劫说道：好，好，好！" + fighter->query("name") + "，你愿意拜我等为师吗？\n");
