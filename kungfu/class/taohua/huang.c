...
void create()
{
	set_name("黄岛主", ({"huang yaoshi", "huang", "yaoshi"}));
	set("title", "桃花岛主");
	...
	set_skill("tanzhi-shentong", 270);   // 弹指惊雷
	set_skill("unarmed", 220);	   // 基本拳脚
	set_skill("strike", 220);	    // 基本拳脚
	set_skill("luoying-shenzhang", 250); // 落红凝剑掌
	...
	set("inquiry", ([
		...
		"离岛"      : (: ask_leave :),
		"黄帮主"      : "你敢直称我女儿的闺名？ ",
		"玄阴真经"  : "如果你能帮我取得真经上册，我一定重重谢你。",
		"兰花手"    : "幽兰拂穴手... 唉，可惜我几个弟子都算不得成才！",
		"弹指惊雷"  : "我... 我... 一身绝艺竟然无人可以继承？",
...
void attempt_apprentice(object ob)
{
	...
	if (ob->query("combat_exp") < 200000)
	{
		...
		if (ob->query("family/family_name") == "桃花岛" &&
		    ob->query("family/master_name") != "黄岛主")
		{
