...
void create()
{
	...
	set_skill("beiming-shengong", 240);	// 青冥神功
	set_skill("finger", 220);		// 基本指法
	set_skill("six-finger", 220);		// 六极神剑
	set_skill("dodge", 250);		// 基本躲闪
	set_skill("lingbo-weibu", 250);		// 洛神步法
...
void check_enemys(object wang)
{
	...
	{
		message_vision(HIC "汪玉嫣在$N耳边嘀嘀咕咕的说些话。"NOR"\n", this_object());
