...
void create()
{
	set_name("风轻洋", ({ "feng qingyang", "feng", "qingyang" }));
	set("title", "华山第十二代剑宗长老");
	set("long", @LONG
这便是当年名震江湖的华山名宿风轻洋。他身著青袍，神气抑郁脸如金
...
mixed teach_lonely_sword()
{
	...
	if (me->query_skill("lonely-sword", 1) > 90)
	{
		...
		command("say 你的九剑归一也算是有些成就了，这剑法要靠"
			"自己勤练，以后你自己多加钻研吧！");
...
int recognize_apprentice(object ob, string skill)
{
	...
	{
		command("say 好一个邪魔外道，我风轻洋没兴趣和你这"
			"种人打交道，你走吧。");
		ob->set_temp("have_asked_feng", 1);
		return -1;
	}
...
int accept_ask(object me, string topic)
{
	...
	{
		command("say 你会"ZJURL("cmds:learn feng lonely-sword 100")"九剑归一"NOR"么？就向我问这个？");
		return 1;
	}
