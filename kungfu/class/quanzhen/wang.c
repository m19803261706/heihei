...
void create()
{
	...
	set("no_teach/sun-finger", "玄阳指是段家秘传，我不能教你。");
...
string ask_jiuyin()
{
	...
	return "玄阴真经是天下武学正宗，我已交给我师弟周博通保管。";
}
...
mixed ask_hua()
{
	...
	if (me->query_skill("xiantian-gong", 1) < 100)
		return "使用一气化三清需要我周天功为基础，你先把基础打好再说。";
