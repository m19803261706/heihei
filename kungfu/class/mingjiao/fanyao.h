...
// 1.2.3.4.
	...
	for (j = 1; j < 5; j++)
	{
		...
		message("vision", "\n范曜走了过来，跟" + monk->query("name") + "俯耳轻声说了几句。\n", room, monk);
...
int waiting(object me)
{
	...
	{
		if( random(10) == 0 ) 
		say("\n范曜说道：" + RANK_D->query_respect(fighter) + "去请了杨左使没有？ 照理他现在该到了罢？\n");
...
int preparing(object me, object fighter)
{
 object  room;
	...
	say( "范曜说道：不相干的人，如不欲现场观摩光明圣火阵，请即刻离开此处。\n");
...
int do_recruit(object me, object fighter)
{
 mapping ft_fam;
	...
	{
		command("smile");
		say("范曜说道：" + RANK_D->query_respect(fighter) + "武功卓绝，兼又手下留情，品德更是过人一筹，范曜不胜佩服之至！\n");
		call_out("do_back", 5, me );
	}
	else
	{
		say("\n范曜说道：好，好，好！" + fighter->query("name") + "，没想到教中出了你这样一个人才？\n");
		call_out("do_back", 5, me );
	}
	return 1;
}
