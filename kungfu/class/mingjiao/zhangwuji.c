...
{
    seteuid(getuid());
    set_name("张无极", ({ "zhang wuji", "zhang", "wuji" }));
    set("long", @LONG
明教教主张无极，统领天下十万教众，豪气干云，叱咤千秋，
「紫阳神功」、「乾坤大挪移」独步天下，是江湖中不世出的
少年英雄。
LONG );
    ...
    set("chat_chance", 1);
    set("chat_msg", ({
	"张无极愤然说道“大丈夫当以国为家, 捐躯沙场, 抗元大业未成, 同辈仍需努力!”\n",
	"张无极叹道“人生失一知己, 生亦何欢, 死亦何忧, 敏儿, 你在哪里?”\n",
	"张无极道“我教兄弟听了: 生于乱世, 当克己为公, 行侠仗义, 荡寇驱魔!”\n",
    }));
...
int accept_fight(object ob)
{
	...
	message_vision("张无极一拱手说道：这位" + RANK_D->query_respect(ob) +
		       "，在下领教了。\n", ob);
	return 1;
}
string ask_ling()
