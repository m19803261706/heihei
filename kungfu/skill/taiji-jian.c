...
"太极剑法乃三丰真人晚年继太极拳所创，实是近世登峰造极的剑术，$N功劲一加运开，绵绵不绝，绝无破绽",
...
"$N$w随手一招打出，以己之钝，挡敌之无锋，正是三丰真人传授的太极剑「剑意」的精奥神髓",
...
string query_txt()
{
	return "要求：内力1500，内功激发200，太极拳100，基本剑法100，技能等级不能高于太极神功+30、太极拳+30以及基本剑法"ZJBR
	"特效：招架化解对手的攻击，对比自身(招架激发/4+技能等级)和攻击者内功激发，同等级1/3概率触发，受阴阳八卦克制";
}
...
mixed valid_damage(object ob, object me, int damage, object weapon)
{
	...
	dp = me->query_skill("parry") / 4 + me->query_skill("taiji-jian", 1);
