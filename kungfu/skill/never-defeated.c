...
string query_txt()
{
	return "说明：要求狡黠多变性格，经验300万，武学修养50（武学修养300后不再限制不败神功等级），先天悟性22，太监只能学到240级。";
}
...
string *usage_skills = ({ "sword", "blade", "dagger","staff", "hammer", "club", "whip","dodge", "parry", "force", "throwing" });
