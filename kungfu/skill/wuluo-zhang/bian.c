...
int perform(object me, object target)
{
	...
	if ((lvl = (int)me->query_skill("wuluo-zhang", 1)) < 100)
		return notify_fail("你绫罗青烟掌不够娴熟，难以施展" BIAN "。\n");

	if (me->query_skill_mapped("strike") != "wuluo-zhang")
		return notify_fail("你没有激发绫罗青烟掌，难以施展" BIAN "。\n");

	if (me->query_skill_prepared("strike") != "wuluo-zhang")
		return notify_fail("你没有准备绫罗青烟掌，难以施展" BIAN "。\n");
	...
	msg = HIC "$N" HIC "施出绫罗青烟掌绝技，单掌轻轻一抖，登时化出五道掌"
	      "影，轻飘飘向$n" HIC "拍去。"NOR"\n";
	me->add("neili", -50);
