...
void create()
{
	set_name("新手大礼包", ({"new gift2"}));
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("long", "正式新手礼包，感谢大家对游戏的支持，祝您游戏愉快！\n");
		set("base_unit", "个");
		set("base_weight", 1);
		set("base_value", 1000);
		set("no_put", 1);
...
int do_effect(object me)
{
	...
	gifts = ([
		"/clone/vip/avipcard":1,
		"/clone/vip/dan_chongmai1":50,
		"/clone/vip/dan_jiuzhuan":4,
	]);
	...
	if (me->query("newgift_box_times2"))
	...
	tell_object(me, HIY"你获得了5万经验，40万点潜能。"NOR+HIG"全体管理祝你游戏愉快！"NOR"\n");
	add_amount(-1);
