...
int main(object me, string arg)
{
	...
	if(!arg)
	{
		// write(ZJBTSET"b12:"HIG"我的"ZJBR"属性"NOR":score"ZJSEP"b13:"HIY"角色"ZJBR"健康"NOR":hp"ZJSEP"b14:"HIR"断线"ZJBR"防卡"NOR":look"ZJSEP
		// "b15:"HIM"游戏"ZJBR"队伍"NOR":team"ZJSEP"b16:"HIW"角色"ZJBR"技能"NOR":skills"ZJSEP"b17:"HIC"世界"ZJBR"交流"NOR":liaotian"+"\n");
		write(ZJBTSET"b12:"HIG"常用"ZJBR"功能"NOR":mycmds ofen"ZJSEP"b13:"HIY"武学"ZJBR"相关"NOR":mycmds skill"ZJSEP"b14:"HIR"战斗"ZJBR"相关"NOR":mycmds fight"ZJSEP
			"b15:"HIM"任务"ZJBR"相关"NOR":mycmds quest"ZJSEP"b16:"HIW"萌新"ZJBR"系统"NOR":flygo"ZJSEP"b17:"HIC"频道"ZJBR"交流"NOR":liaotian"+"\n");
		// write(ZJTTMENU" 飞行:help mapb"ZJSEP"功能:flygo"ZJSEP"寻路:walk"ZJSEP"地图:new_map\n");
		// write(ZJTTMENU"功能:flygo"ZJSEP"寻路:walk\n");
	}
        else if(arg=="ofen") 
                write(ZJBTSET"b1:查看"ZJBR"背包:i"ZJSEP"b2:综合"ZJBR"属性:score"ZJSEP"b3:健康"ZJBR"状态:hp" 
                        ZJSEP"b4:查看"ZJBR"装备:arm"ZJSEP"b5:角色↑"ZJBR"家园↑:uplv"ZJSEP"b6:御风"ZJBR"飞行:help mapb"ZJSEP"b8:帮会"ZJBR"相关:banghui" 
                        ZJSEP"b7:队伍"ZJBR"信息"NOR":team"ZJSEP"b9:"YEL"随身"ZJBR"商城"NOR":myshop"ZJSEP"b10:玩家"ZJBR"排行:tops"/*ZJSEP+
		...
		write(ZJBTSET"b1:查看"ZJBR"技能:skills"ZJSEP"b2:日常"ZJBR"练功:help liangong"ZJSEP"b3:内力"ZJBR"回血:exert recover"
			...
			ZJSEP"b7:内力"ZJBR"疗疾:exert dispel"ZJSEP"b8:内功"ZJBR"加力:enforce"ZJSEP"b9:战斗"ZJBR"信息:set combatd"ZJSEP"b10:"HIY"技能"ZJBR"显示"NOR":set nocha_skills"ZJSEP"b11:天赋"ZJBR"技能:special"+"\n");
	else if(arg=="fight")
	{
		str = ZJBTSET;
		for(i=1;i<11;i++)
		...
		write(ZJBTSET"b1:"HIC"闲聊"NOR":liaotian chat"ZJSEP"b2:"HIM"传闻"NOR":liaotian rumor"ZJSEP"b3:"HIY"帮派"NOR":liaotian party"
		...
		write(ZJBTSET"b1:查看"ZJBR"任务:quest"ZJSEP/*"b2:使用"ZJBR"八卦:use ba gua"ZJSEP"b3:中止"ZJBR"挂机:unset sign1"
			ZJSEP*/"b4:战令"ZJBR"系统:zhanling"ZJSEP"b5:门客"ZJBR"系统:menke_system"ZJSEP"b7:元宝"ZJBR"说明:help pay"ZJSEP/*"b8:会员"ZJBR"福利:help vip"
			ZJSEP"b6:地图"ZJBR"相关:help mapb"ZJSEP*/"b9:搜索"ZJBR"本地:search"/*ZJSEP"b10:随身"ZJBR"购买:look"ZJSEP"b11:乘雕"ZJBR"飞行:help mapb"*/+"\n");
	else if(arg=="help")
		write(ZJBTSET"b1:更新"ZJBR"公告:help anews"ZJSEP"b2:"HIG"新手"ZJBR"指南"NOR":help newbie"ZJSEP"b3:基本"ZJBR"系统:help"ZJSEP"b4:门派"ZJBR"世家:help menpai"
			ZJSEP"b5:游戏"ZJBR"特色:help feature"ZJSEP"b6:技能"ZJBR"介绍:help skills"ZJSEP"b7:暂无"ZJBR"说明:look"ZJSEP"b8:会员"ZJBR"福利:help vip"
