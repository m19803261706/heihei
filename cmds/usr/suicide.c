...
int main(object me, string arg)
{
	...
	if( me->query("banghui"))
	{
		return notify_fail("你还有一帮兄弟在江湖里，怎么舍得自杀？\n");
	}
	...
	{
		return notify_fail("提示：你的经验超出范围，不能再自杀了。\n");
	}

	if (me->query("menke_system/summon"))
	{
		return notify_fail("你还有门客在江湖里，怎么舍得自杀？\n");
	}
