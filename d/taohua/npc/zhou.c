...
void create()
{
	set_name("周博通", ({ "zhou botong", "zhou", "bo tong" }));
	set("gender", "男性");
	...
	set("inquiry", ([
		"玄阴真经" : "「玄阴真经」就在我床上，你有本事杀了我或把我逼出山洞就可以取走！\n",
		"黄岛主"   : "他囚了我十五年，总想把我逼出山洞以取「玄阴真经」，\n可他每次来都是扫兴而归！\n",
		"英姑"     : "我、我、、我不认识她！",
		"蛇"       : "不要吓我，我最怕蛇了！\n",
		"结拜"     :  (: jie_bai :),
		"拜把兄弟" :  (: jie_bai :),
...
int jie_bai()
{
	...
	tell_object(ob,GRN "周博通悄悄对你说：老哥哥有一套「双手互搏之术」和一路\n"
	"「空灵拳」可以传给你作为见面礼哟！不过，你必须是全真弟子才可以向我学习。"NOR"\n" );
