...
void create()
{
	...
	set("gender", "男性");
	set("age", 45);
	set("long", "他就是「福威镖局」的总镖头－－林镇南。\n");

	set("combat_exp", 800000);
	set("shen_type", 1);
	set("no_get","林镇南对你来说太重了。\n");
	...
	set("inquiry", ([
		"向阳老宅" : "林镇南说道：那是我从前在福建时住的家院，已经破败了。\n",
		"福威镖局" : (: ask_fuwei :),
		"远图公" : (: ask_yuantu :),
		"林元屠" : "林镇南大怒：小孩子这么没礼貌，直呼先人名讳！\n",
		"胜邪剑法" : (: ask_pixie:),
		"铜钱" : (: ask_tong:),
		"护镖" : (: test_dart :),
	]) );
...
int ask_fuwei()
{
 say("林镇南炫耀地说：我们林家三代走镖，一来仗着先祖远图公当年闯下的威名，二\n"
...
int ask_yuantu()
{
 ...
 say("林镇南磕一磕烟斗，说道：远图公是我的祖父，福威镖局是他一手创办的。当年\n"
     "祖父以七十二路胜邪剑法开创镖局，当真是打遍黑道无敌手。其时白道上英雄见\n"
     "他太过威风，也有去找他比试武艺的，青城派掌门余观主的师父常青子少年之时\n"
     "便在他胜邪剑法下输了几招。\n");
...
int ask_pixie()
{
 ...
 say("林镇南不悦地说道：我不是都告诉你了吗？我的剑法不及先祖。\n");
  }
  else if ((int)this_player()->query_temp("marks/林2")) {
 say("林镇南一惊，说道：你怎么知道的？噢，我刚才说露嘴了。嗨，在下的功夫外人\n"
     "不知底细，其实及不上先祖。。\n");
 write("林镇南顿一顿，接着对你低声说：先祖去世前，曾给家父留下");
 p1=random(4)+1;
 p2=random(4)+1;
 p3=random(4)+1;
 p4=random(4)+1;
 ...
 write("个\n铜钱，我一直未解其中奥秘。\n");
   ...
   message("vision",
   HIY "林镇南勃然大怒，喝道：你也窥视我们林家的辟邪剑谱？！我跟你拼了！\n"
...
int ask_tong()
{
 ...
 say("林镇南一脸讥笑的样子，说：怎么混到这一步了到处要钱？\n");
  }
  else {
 write("林镇南低声说：先祖去世前，曾给家父留下");
 p1=(int)p/1000;
