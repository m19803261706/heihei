...
void do_give(object me)
{
	...
	message_vision("沐婠清将绝情花吃了下去，她中的「阴阳合和散」的药性解除了！\n",me);
	command("say 太谢谢了，我这就要离开这是非之地，后会有期！");
	message_vision("沐婠清取出一根彩菱往外一抛，身影如风一般飞了出去。\n",me);
