...
string ask_for_zigong()
{
	...
	if ((int)me->query_str() > 30)
		return "这位好汉过于粗壮，自宫有碍观瞻，不妥，不妥。( 人物当前臂力不能大于30 )\n";
...
int do_decide()
{
	...
	message_vision(HIC "海巨富叹了口气，道：既然这样……小贵子，过来帮我给这"
	...
	command("chat 东厂海巨富今日为" + me->name(1) + "净身，行下入宫之礼。");
