...
void create()
{
	...
	"真经里记载了催心掌、玄阴炼骨爪、易筋锻骨和幻阴步，你可以试着研究研究。"NOR"\n", );
	}
}
...
*/
	...
	{
		write(HIW "你可以从玄阴真经里研究到易筋锻骨（yijin-duangu），幻阴步（huanyinbu），\n"
...
*/
	...
	if (skill == "huanyinbu")
	{
		...
		write("你仔细研读玄阴真经，对真经里所记载的幻阴步轻功颇有心得。\n");
	}
	else
