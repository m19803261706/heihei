...
int start_yitian()
{
	shout(HIR "\n【倚天屠龙】" NOR+WHT "赵闵冷哼几声，露出不屑的眼神。" NOR );
	shout(HIR "\n【倚天屠龙】" NOR+WHT "赵闵：不错！倚天剑就在我手中，有本事就尽管到万安寺中来拿。"NOR"\n" );
	CHANNEL_D->do_channel(this_object(), "chat", "赵闵一众携带倚天剑出现在万安寺，倚天剑剧情启动。");
	set("open",1);
...
int valid_leave(object me, string dir)
{
	if (dir=="north"&&!this_object()->query("open"))
      ...
      if (dir=="north"&& me->query("combat_exp", 1)<1000000 )
		return notify_fail("你这么点低微的武功恐怕无法从赵闵手中抢回倚天剑吧？\n");
