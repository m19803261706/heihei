...
{
	seteuid(getuid());
	set_name("谢燕客", ({ "xie yanke", "xie" }));
	set("long", @LONG
摩天居士谢燕客乃天下第一奇人，武功高强，曾经散出
...
int accept_object(object me, object ob)
{
	...
	{
		command("say 很好，很好！");
		command("say 我这里有一套清荷针掌，是我晚年创下的绝学，可以传授予你。");
...
mixed ask_me()
{
	...
	if (me->query_skill("bizhen-qingzhang", 1) < 180)
		return "你的清荷针掌练这个程度就来问绝招？等你180级以后再来吧！";
	...
	tell_object(me, HIC "你学会了清荷针掌「澎湃」这一招。"NOR"\n");
