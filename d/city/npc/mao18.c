...
void create() 
{ 
	set_name("茅人雄", ({ "mao shiba", "mao", "shiba" })); 
	set("gender", "男性"); 
	set("age", 30); 
	set("str", 25); 
	set("dex", 16); 
	...
	set("chat_chance", 2); 
	set("chat_msg", ({ 
		"\n茅人雄说道: 他奶奶的，我就不信鳌拜有这等厉害,\n" 
		"我正要上北京去斗他一斗。" , 
		"\n茅人雄叹道: 用我这五虎断门刀法对付盐枭可是绰绰有余,只不知对付鳌拜行不行。\n", 
		"\n茅人雄说道: 江湖威望很重要！威望高大有好处啊...\n", 
		"\n茅人雄说道: 他奶奶的，谁帮我杀了史嵩，兄弟我谢谢你了！\n", 
		"\n茅人雄说道: 老听人说，那鳌拜是满洲第一武士，他妈的,\n" 
		"还有人说他是天下第一勇士，我可不服气，要上北京去跟他比划比划。\n" , 
		"\n茅人雄朗声说道：江湖有言：“为人不识陈劲南，就称英雄也枉然。”\n", 
		(: random_move :) 
	}) ); 
	setup(); 
...
void die() 
{ 
	say("茅人雄哈哈大笑道：托韦兄弟的福，我见过了陈劲南总舵主，虽死无憾啊！\n"); 
	::die(); 
} 
