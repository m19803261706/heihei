...
void create()
{
	set("short", "幽冥幻境");
	set("long", @LONG
幽冥幻境，一个充满神秘与诡异的地下世界。这里曾是古代一位神秘高手的修炼之地，传说中高手修炼的秘术可以操控生死，驱使鬼神。但随着高手的失踪，这片幻境逐渐被遗忘，成为了各种妖魔鬼怪聚集的场所。传闻，幻境深处隐藏着一份神秘的宝藏，引得无数英雄豪杰前往探险。
LONG);
...
int start_fuben_moku(object who)
{
	...
	{
		tell_object(who, "幽冥幻境邪气过重，一天无法进入两次。\n");
		return 0;
	}
